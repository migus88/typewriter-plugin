...
- The macro **name** can't collide with built-in macros (`pause`, `reformat`, `complete`, `import`, `caret`, `backspace`, `backspace-hold`, `goto`, `snip`, `key`, `br`), can't contain whitespace or `:`, and must be unique across all languages.
