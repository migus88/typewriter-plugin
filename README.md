...
- The content editor uses the same auto-completion as the script tabs: type the opening marker to get a popup of every built-in and custom macro, or type two identifier characters to get word completion.
